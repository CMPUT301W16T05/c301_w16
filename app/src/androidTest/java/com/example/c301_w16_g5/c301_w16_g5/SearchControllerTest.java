...
public class SearchControllerTest extends ActivityInstrumentationTestCase2 {
    ...
    public void testAddChickenTask() {
        User user = new User("jsmith","John","Smith","jsmith@gmail.com","5875555555","Loads");
        Chicken chicken = new Chicken("Bob","Very friendly",Chicken.ChickenStatus.AVAILABLE,user);
    ...
    public void testGetChickenByIdTask() {
        User user = new User("jsmith","John","Smith","jsmith@gmail.com","5875555555","Loads");
        Chicken chicken1 = new Chicken("Bob","Very friendly",Chicken.ChickenStatus.AVAILABLE,user);
        ...
        assertEquals(chicken1.getOwner(),chicken2.getOwner());
